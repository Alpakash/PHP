...
<div class="full-width-img-lotr"> <!-- Show background image on home -->
...
// get data from the game_id's from the database table games
        $game = $gameObj->gameData(4); // Game of Thrones object
...
// if user is logged out he can't visit the 'game' and gets redirected to 'home' page
        ...
        if (isset($_POST['username'])) {
          ...
          // if the usernames (players) are not selected redirect back to games with an error to select players on the game-selection page
        if (!isset($_POST['username'])) {
                header('Location: games?playerserror=1');
        } else if (count($_POST['username']) < $game->min_players) {
                header('Location: games?playerserror=lotr');
    ...
    <div class="container-fluid welcome">
        ...
        <div class="opacitybg">
            <h3>Now Playing:</h3>
            <h1 class="display-3">Lord of the Rings boardgame</h1>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form to select winner, redirect to execute the logic @ 'winner/lotr' page to update the winners column in games table -->
                <form method="GET" action="/winner/lotr">

                    <!-- input type to give a battle name and send it to the winnerwow.view.php-->
                    <div class="form-group">
                        <input type="text" name="battleName" class="form-control" id="formGroupExampleInput" placeholder="Write down a cool battle name ..">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select name="winnerName" class="custom-select" id="inputGroupSelect01">
                            ...
                            <!-- Get this $users from the PagesController in the lotr function -->
                            <?php foreach ($usernames as $username) : ?>
                    ...
                    <!-- In the winnerlotr.php these GETs turn into variables that will be put in the battles table -->
                    <!-- $_GET['player0'] = player1 = score1 -->
                    <!-- $_GET['player1'] = player2 = score2 -->
                    <!-- $_GET['player2'] = player3 = score3 -->
                    <!-- $_GET['player3'] = player4 = score4 -->
                    <!-- $_GET['player4'] = player5 = score5 -->
                    <!-- $_GET['player5'] = player6 = score6 -->
            ...
            <div class="modal-footer">
                ...
                <!-- Save the form information and redirect to '/winner/lotr' page-->
