...
<div class="full-width-img-wow"> <!-- Show background image on wow page -->
...
// get data from the game_id's from the database table games
        $game = $gameObj->gameData(3); // World of Warcraft object
...
// if user is logged out he can't visit the 'game' and gets redirected to 'home' page
        ...
        // and give a error to select players on the game-selection page
           if (!isset($_POST['username'])) {
                ...
                header('Location: /games?playerserror=wow');
    ...
    <div class="container-fluid welcome">
        ...
        <div class="opacitybg">
            <h3>Now Playing:</h3>
            <h1 class="display-3">World of Warcraft boardgame</h1>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form to select winner, redirect to execute the logic @ 'winner/wow' page to update the winners column in games table -->
                <form method="GET" action="/winner/wow">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select name="winnerName" class="custom-select" id="inputGroupSelect01">
                            ...
                            <!-- Get this $users from the PagesController in the wow function -->
                            <?php foreach ($usernames as $username) : ?>
                    ...
                    <!-- In the winnerwow.php these GETs turn into variables that will be put in the battles table -->
            ...
            <div class="modal-footer">
                ...
                <!-- Save the form information and redirect to '/winner/wow' page-->
